...
```{r}
label <- paste("<p>","Country Name: ",powerplant_emissions1$country_name,"</p>",
  "<p>","Emissions: ",powerplant_emissions1$emissions_total_2014,"</p>",
               sep = "")
```
...
#                bringToFront = TRUE)
  ...
  addLegend(pal = pal,
            values = powerplant_emissions1$emissions_total_2014,
            opacity = 0.7,
            position = "topright",
            title = "GHG Emissions") %>%
    addLegend(pal = pal2,
  ...
  addCircleMarkers(lat = ~latitude, lng = ~longitude,
                   ...
                   fillOpacity = 0.8,
                   group = "Power Plants") %>%
  addLayersControl(overlayGroups = c("GHG Emissions", "Fuel Category"),
